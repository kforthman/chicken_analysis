...
# batch_num is the number of simulations you would like to generate and then average across
# m is the number of trials
# feedback designates whether you would like the simulated participant to recieve feedback on its response
# pred denotes whether the task is prediction or estimation
